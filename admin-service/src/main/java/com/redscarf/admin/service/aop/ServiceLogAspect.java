package com.redscarf.admin.service.aop;
...
public class ServiceLogAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* com.redscarf.admin.service.impl.*.*(..))")
    ...
    @Around("execution(* com.redscarf.admin.service.impl.*.*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value ="execution(* com.redscarf.admin.service.impl.*.*(..))",returning = "reponse")
