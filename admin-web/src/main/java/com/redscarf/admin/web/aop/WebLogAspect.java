package com.redscarf.admin.web.aop;
...
public class WebLogAspect {
    ...
    @Before("execution(* com.redscarf.admin.web.controller..*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value = "execution(* com.redscarf.admin.web.controller..*(..)) or execution(* com.redscarf.admin.web.exception..*(..))",returning = "reponse")
